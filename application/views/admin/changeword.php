                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
									...
									<input class="common-text required" id="username" name="username" size="50" type="hidden" value="<?php echo $this->session->userdata('username');?>">
                                     <input class="common-text required" id="UId" name="UId" size="50" type="hidden" value="<?php echo $this->session->userdata('UId');?>">
                                     <input class="common-text required" id="oldpassword" name="oldpassword" size="50" type="hidden" value="<?php echo $this->session->userdata('password');?>">
                                </td>
                            </tr>
                            <tr>
                                <th>登录密码：</th>
                            ...
                            <tr>
                                ...
                                <input class="common-text required" id="email" name="email" size="50" type="hidden" value="<?php echo $this->session->userdata('email');?>">
                            </tr>
                            <tr>
                                <th>真实姓名：</th>
                                <td><input class="common-text" name="realName" id="realName" size="50" type="text" value="<?php echo $this->session->userdata('realName');?>"></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
