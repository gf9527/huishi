<?php $header;?>
    ...
    <div class="main-wrap">
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo $this->config->item('base_url');?>/admin/Navigate/doadd" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <tbody><tr>
                            ...
                            <td>
                                ...
                                <?php if(!empty($navlist)) foreach($navlist as $k=>$v){?>
                                    <option value="<?php echo $v['pNavId']?>"><?php echo $v['pNavName']?></option>
                                <?php }?>
                                </select>
                            </td>
                        </tr>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" placeholder="请输入导航名称" id="sNavName" name="sNavName" size="50" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>导航链接：</th>
                                <td><input class="common-text" name="sNavUrl" id="sNavUrl" size="50" placeholder="输入参考： /所属导航/导航名称" type="text"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>导航排序：</th>
                                <td><input class="common-text" name="sort" id="sort" size="50" placeholder="请输入数字，数字越大导航越靠前" type="text"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>关键字：</th>
                                <td>
                                    <input class="common-text required" placeholder="请输入关键字" id="keyword" name="keyword" size="50" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
