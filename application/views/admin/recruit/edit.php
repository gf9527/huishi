    ...
    <div class="main-wrap">
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo $this->config->item('base_url');?>/admin/Recruit/doedit" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>招聘标题：</th>
                                <td>
                                    <input class="common-text required" value="<?php echo !empty($info['title']) ? $info['title'] : '';?> "id="title" name="title" size="50" type="text">
                                </td>
                                <input type="hidden" name="rId" id="rId" value="<?php echo !empty($info['rId']) ? $info['rId'] : '';?> "
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>工资：</th>
                                <td><input class="common-text" name="wages" id="wages" size="50"  value="<?php echo !empty($info['wages']) ? $info['wages'] : '';?>" type="text"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>学历要求：</th>
                                <td><input class="common-text" name="education" id="education" size="50" type="text" value="<?php echo !empty($info['education']) ? $info['education'] : '';?>"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>经验要求：</th>
                                <td><input class="common-text" name="experience" id="experience" size="50" type="text" value="<?php echo !empty($info['experience']) ? $info['experience'] : '';?>"></td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>招聘简介：</th>
                                <td>
                                <script id="contents" name="contents" type="text/plain" width="500">
        <?php echo !empty($info['contents']) ? $info['contents'] : '';?>
    </script>
    							</td>
                            </tr>
                            <tr>
