              ...
              <table width="99%" border="0" align ="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="t12black" id="fontzoom" style="line-height:24px; padding-top:20px">
                    <p><strong>联系电话：</strong>&nbsp;&nbsp;<?php echo $info['phoneNumber'];?></p>
                    <p><strong>公司QQ：</strong>&nbsp;&nbsp;<?php echo $info['companyQQ'];?></p>
                    <p><strong>官方微博：</strong>&nbsp;&nbsp;<?php echo $info['weibo'];?></p>
                    <p><strong>公众号：</strong>&nbsp;&nbsp;<?php echo $info['wechat'];?></p>
                    <p><strong>公司地址：</strong>&nbsp;&nbsp;<?php echo $info['address'];?></p>
                  </td>
                </tr>
              </table>
             <br><br>
