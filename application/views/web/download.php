...
<DIV id="right_menu" style="BACKGROUND: url(<?php echo $this->config->item('base_url');?>/public/index/Images/partat5.gif) no-repeat top left;">
    ...
    <UL style="padding:0 0">
      <li><a href='<?php echo $this->config->item('base_url').'/Index/Service/';?>'>&nbsp;&nbsp;服务体系</a></li><li><a href='<?php echo $this->config->item('base_url').'/Index/download';?>'><font style='WIDTH: 230px; DISPLAY: block; HEIGHT: 24px;  TEXT-DECORATION: none; font-size:12px;color:#027DEF'>&nbsp;&nbsp;下载中心</font></a></li>
    </UL>
    <br style="clear:both;" />
...
<table width='100%' border='0' cellspacing='0' cellpadding='0' height='1px' style='border-bottom:1px solid #ccc; margin-top:2px'><tr><td><img src='<?php echo $this->config->item('base_url');?>/public/index/Picture/spacer.gif'></td></tr></table>
              <table align="center" style="margin:0 auto; margin-top:10px">
                <tr>
                  <td class="t14b" style="padding-bottom:5px"><?php echo !empty($info['editionName']) ? $info['editionName'] : '';?></td>
                </tr>
              </table></td>
            </tr>
            <tr>
...
<P class=MsoNormal style="TEXT-ALIGN: left; MARGIN: 0cm 0cm 0pt; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; mso-pagination: widow-orphan" align=left><SPAN lang=EN-US style="FONT-SIZE: 9pt; FONT-FAMILY: 宋体; COLOR: #030303; mso-bidi-font-family: 宋体; mso-font-kerning: 0pt"></div>
                  ...
                  <a style="float:right" href="<?php echo !empty($info['filepath']) ? $info['filepath'] : '';?>"><img src="<?php echo $this->config->item('base_url').'/public/index/Images/download.jpg';?>" width="100" height="70"></a>
                  </td>
                </tr>
              </table>
             <br><br>
...
<div id="bottom_all">
    <div style="width:1000px; margin:0px auto; height:75px;">
        ...
        版权所有 北达正视（北京）科技有限公司 京ICP备13028660号
        </div>
        <div style="width:300px; font-size:13px; margin:0 auto; padding:34px 5px 0 0; color: #333; float:right"><a href="list.asp?bc=1&sc=19" class="foota">招贤纳才</a> | <a href="sitemap.asp">网站地图</a> | <a href="list.asp?bc=1&sc=20">联系我们</a> | <a href="list.asp?bc=1&sc=21">免责声明</a></div>
    </div>
</div>
<!--版权信息部分 -->
