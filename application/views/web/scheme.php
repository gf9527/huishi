...
<DIV id="right_menu" style="BACKGROUND: url(<?php echo $this->config->item('base_url');?>/public/index/Images/partat3.gif) no-repeat top left;">
    <H3><a href="list.asp?bc=3"><B><?php echo $navName?></B></a></H3>
    <UL style="padding:0 0">
     
      
      <li><a href='<?php echo $this->config->item('base_url').'/Index/scheme?type=0';?>'><?php if($type == 0){echo '<font class="leftsc">';}?>&nbsp;&nbsp;成功案例</font></a></li>
    <li><a href='<?php echo $this->config->item('base_url').'/Index/scheme?type=1';?>'><?php if($type == 1){echo '<font class="leftsc">';}?>&nbsp;&nbsp;解决方案</font></a></li>
    </UL>
    <br style="clear:both;" />
    ...
    <tr valign='top'>
        ...
        <tr>
        	...
        	<a href='<?php echo $this->config->item('base_url').'/Index/schemecontents/'.$val['sId'];?>'><img src='<?php echo $this->config->item('img_url').$val['imageName'];?>' width='260' height='180' border='0'>
            </a>
            </td>
            <td width='400' height='30'>
            <a href='<?php echo $this->config->item('base_url').'/Index/schemecontents/'.$val['sId'];?>' class='nav2'><?php echo $val['title']?></a>
            </td>
            <td width='20' rowspan='2'>
            <a href='<?php echo $this->config->item('base_url').'/Index/schemecontents/'.$val['sId'];?>'>
